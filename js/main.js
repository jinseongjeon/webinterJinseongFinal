(() => {
    ...
    const sceneInfo = [
        ...
        },        
        {
            ...
            values: {
				...
				messageC_translateY_out: [0, -20, { start: 0.85, end: 1 }],
				messageA_opacity_out: [1, 0, { start: 0.3, end: 0.35 }],
				messageB_opacity_out: [1, 0, { start: 0.58, end: 0.63 }],
				messageC_opacity_out: [1, 0, { start: 0.85, end: 1 }],
				pinB_scaleY: [0.5, 1, { start: 0.5, end: 0.55 }],
				pinC_scaleY: [0.5, 1, { start: 0.72, end: 0.77 }],
				pinB_opacity_in: [0, 1, { start: 0.5, end: 0.55 }],
				pinC_opacity_in: [0, 1, { start: 0.72, end: 0.77 }],
				pinB_opacity_out: [1, 0, { start: 0.58, end: 0.63 }],
				pinC_opacity_out: [1, 0, { start: 0.85, end: 1 }]
			}
        },        
        {   
            //3
            ...
            objs: {
                ...
                imagesPath: [
                    'https://jinseongwebinter.s3.ap-northeast-2.amazonaws.com/images/1.jpg',
                    'https://jinseongwebinter.s3.ap-northeast-2.amazonaws.com/images/2.jpg'
                ],
                images: []
            },
            values: {
    ...
    function setCanvasImages(){
        ...
        for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++){
            ...
            imgElem.src = `https://jinseongwebinter.s3.ap-northeast-2.amazonaws.com/video/003/IMG_${i}.jpg`;
            sceneInfo[0].objs.videoImages.push(imgElem);
        }
        let imgElem2;
        for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++){
            imgElem2 = document.createElement('img');
            imgElem2.src = `https://jinseongwebinter.s3.ap-northeast-2.amazonaws.com/video/004/IMG_${i}.jpg`;
        ...
        switch (currentScene) {
            ...
            case 2:
                ...
                if (scrollRatio > 0.9) {
                    ...
                    objs.context.fillRect(parseInt(values.rect1X[0]),0,
                    parseInt(whiteRectWidth), objs.canvas.height);
                    objs.context.fillRect(parseInt(values.rect2X[0]),0,
                    parseInt(whiteRectWidth), objs.canvas.height);
                }
            ...
            case 3:
                //console.log('3 play');
                let step = 0;
                //가로/세로 모두 꽉차게 하기 위해 여기서 세팅(계산이 필요)
                const widthRatio = window.innerWidth / objs.canvas.width;
                const heightRatio = window.innerHeight / objs.canvas.height;
                let canvasScaleRatio;
